...
public class DirectorFileTest {
    ...
    private static void testOpcodes() {
        ...
        System.out.println("  Opcodes: ALL PASS\n");
    }

    private static void testBitmapDecoding() {
        System.out.println("--- Testing Bitmap Decoding ---");

        var BitmapDecoder = com.libreshockwave.bitmap.BitmapDecoder.class;
        var Bitmap = com.libreshockwave.bitmap.Bitmap.class;

        // Test scan width calculation
        int scanWidth = com.libreshockwave.bitmap.BitmapDecoder.calculateScanWidth(100, 8);
        assert scanWidth == 100 : "Scan width for 8-bit failed: " + scanWidth;
        System.out.println("  Scan width (8-bit): PASS");

        scanWidth = com.libreshockwave.bitmap.BitmapDecoder.calculateScanWidth(100, 1);
        ...
        byte[] decompressed = com.libreshockwave.bitmap.BitmapDecoder.decompressRLE(compressed, 10);
        ...
        decompressed = com.libreshockwave.bitmap.BitmapDecoder.decompressRLE(compressed, 10);
        ...
        // Test Bitmap class
        var bitmap = new com.libreshockwave.bitmap.Bitmap(10, 10, 32);
