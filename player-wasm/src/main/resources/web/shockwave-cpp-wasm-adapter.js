(function(root, factory) {
    ...
    var fallbackExports = {
        addTraceHandler: ['add_trace_handler', noop],
        removeTraceHandler: ['remove_trace_handler', noop],
        clearTraceHandlers: ['clear_trace_handlers', noop],
        setDebugPlaybackEnabled: ['set_debug_playback_enabled', noop],
        getDebugLog: ['get_debug_log', zero],
        render: ['render', zero],
        getRenderBufferAddress: ['get_render_buffer_address', zero],
        getSpriteCount: ['get_sprite_count', zero],
        getCursorType: ['get_cursor_type', zero],
        updateCursorBitmap: ['update_cursor_bitmap', zero],
        getCursorBitmapWidth: ['get_cursor_bitmap_width', zero],
        getCursorBitmapHeight: ['get_cursor_bitmap_height', zero],
        getCursorBitmapLength: ['get_cursor_bitmap_length', zero],
        getCursorBitmapAddress: ['get_cursor_bitmap_address', zero],
        getCursorRegPointX: ['get_cursor_reg_point_x', zero],
        getCursorRegPointY: ['get_cursor_reg_point_y', zero],
        isCaretVisible: ['is_caret_visible', zero],
        getCaretX: ['get_caret_x', zero],
        getCaretY: ['get_caret_y', zero],
        getCaretHeight: ['get_caret_height', zero],
        getSelectionRectCount: ['get_selection_rect_count', zero],
        getSelectionRectX: ['get_selection_rect_x', zero],
        getSelectionRectY: ['get_selection_rect_y', zero],
        getSelectionRectW: ['get_selection_rect_w', zero],
        getSelectionRectH: ['get_selection_rect_h', zero],
        pasteText: ['paste_text', noop],
        getSelectedTextLength: ['get_selected_text_length', zero],
        cutSelectedText: ['cut_selected_text', zero],
        selectAll: ['select_all', noop],
        triggerTestError: ['trigger_test_error', zero],
        getCallStack: ['get_call_stack', zero],
        getWindowSpriteDiagnostics: ['get_window_sprite_diagnostics', zero],
        getVisibleTextDiagnostics: ['get_visible_text_diagnostics', zero],
        getBootstrapDiagnostics: ['get_bootstrap_diagnostics', zero]
    };
