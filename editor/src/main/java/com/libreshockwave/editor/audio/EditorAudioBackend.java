package com.libreshockwave.editor.audio;
 ...
 */
public class EditorAudioBackend implements AudioBackend {

    private static final int MAX_CHANNELS = 8;

    private final ChannelState[] channels = new ChannelState[MAX_CHANNELS + 1];

    public EditorAudioBackend() {
    ...
    public void play(int channelNum, byte[] audioData, String format, int loopCount) {
        ...
        try {
            ...
            System.err.println("[EditorAudioBackend] Error playing sound on channel " + channelNum + ": " + e.getMessage());
        }
    }
