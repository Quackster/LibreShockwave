...
- Java `Drawing.copyPixels` and ink-mode blending remain implemented through the current C++ VM/render paths and still need extraction into the reusable bitmap drawing module.
