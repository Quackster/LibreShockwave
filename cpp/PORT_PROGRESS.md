...
- `editor::debug` ports Java's debugger combo-box display items, instruction display state, call-target extraction, bytecode cell renderer breakpoint/current-line/navigable-call HTML presentation, and stack/variable/watch/timeout table models as GTK-neutral row/value helpers.
...
- Current checkpoint commit message: `Port C++ bytecode debugger window header`
