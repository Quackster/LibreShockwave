...
- PFR1 curve-command fidelity/rasterization, PFR-to-TTF conversion, TTF rasterization, and bundled platform font families remain deferred to later font-rendering slices.
...
- BitmapFont glyph drawing, overflow metrics, BDF parsing, PFR1 metadata/character-record/simple/compound-outline parsing, and FontRegistry prebuilt-cache/PFR-registration/alias behavior passed through the same CTest executable.
...
- Current checkpoint commit message: `Port C++ PFR1 compound outline parsing`
