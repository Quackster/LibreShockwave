...
- Java `Drawing.copyPixels` rectangle traversal and prop-list handling remain implemented through the current C++ VM/render paths and still need extraction into the reusable bitmap drawing module.
