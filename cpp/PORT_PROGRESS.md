...
- `editor::castbrowser::CastBrowserModels` ports Java's cast-window selector entries, type/search filtering, grid/list row text, selection retention, context action enablement, editor-target routing, and bitmap thumbnail placement math as GTK-neutral cast browser state.
...
- Current checkpoint commit message: `Port C++ editor preview context model`
