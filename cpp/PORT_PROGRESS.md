...
- Browser bridge coverage includes native C ABI export tests that load a synthetic Director movie, start playback, render a shaped score sprite, and verify exact RGBA bytes from the exported render buffer.
