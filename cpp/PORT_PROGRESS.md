...
- `editor::debug::DebugInspectionModels` ports Java's datum-details dialog, detailed-stack window sizing/status/tab/text formatting, state-inspection tab order, Objects tab section metadata, watch panel buttons/prompts/selection routing, and datum double-click detail titles as GTK-neutral inspection views.
...
- Current checkpoint commit message: `Port C++ cast browser layout models`
