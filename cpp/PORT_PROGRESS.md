...
- `editor::EditorFrameModels` ports Java's editor frame panel creation order, floating visibility/default bounds, Window-menu visibility snapshots, show/toggle/reset panel behavior, open-file dialog metadata, and docking interaction as GTK-neutral frame state.
...
- `editor::gtk::GtkWorkbenchTabSpec` ports GTK workbench tab metadata for visible panels, including dynamic titles, active-panel state, focus action bindings, and Window-menu toggle action bindings for future native GTK tab controls.
...
- Current checkpoint commit message: `Port C++ GTK workbench tab state`
