...
- Authored bitmap members now decode or synthesize an unmodified live bitmap on `member.image` reads, including runtime palette-override metadata and registration-point synchronization.
...
- Current checkpoint commit message: `Port C++ authored bitmap image reads`
