...
- Debug/editor foundations: debugger data/control models, breakpoint/watch/expression helpers, lifecycle diagnostics, GTK-neutral editor models, optional GTK shell scaffolding, menu/action/dialog/open-file/workbench/start-screen metadata, dock/floating pane state, GTK4 right-click pane menus, live floating-pane dragging, drag-snap hooks, fixed-position floating pane rendering, and GTK4 action/menu/open-file scaffolding.
