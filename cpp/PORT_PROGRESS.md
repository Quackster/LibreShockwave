...
- `editor::debug::DebugInspectionModels` ports Java's datum-details dialog and detailed-stack window sizing, status strings, tab order, text-area presentation, call-stack formatting, VM-stack formatting, argument formatting, and receiver formatting as GTK-neutral inspection views.
...
- Current checkpoint commit message: `Port C++ editor debug inspection models`
