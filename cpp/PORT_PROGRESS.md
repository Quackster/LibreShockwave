...
- VM-specific `copyPixels` scaling, quad transform, palette-index refresh, color-remap, and Lingo prop-list handling remain implemented in the VM receiver path.
...
- Current checkpoint commit message: `Port C++ decompiler object calls`
