...
- `player::xtra::QueuedMultiuserBridge` ports the Java WASM/browser Multiuser transport bridge with JS-pollable connect/send/disconnect requests, host-delivered connect/error/message/disconnect events, legacy plaintext keepalive/PONG suppression, SMUS logon queuing, SMUS frame packing/unpacking, and SMUS Lingo value encoding/decoding for scalar, media, list, point, rect, color, and prop-list payloads.
...
### Queued JPEG Decoder Foundation
...
### WASM Runtime Bridge Foundation
